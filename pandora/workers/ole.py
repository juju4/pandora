...
class Ole(BaseWorker):
    def __init__(self, module: str, worker_id: int, cache: str, timeout: str, loglevel: int = logging.DEBUG, **options):
    ...
    def analyse(self, task: Task, report: Report, manual_trigger: bool = False):
        ...
        if issubclass(oid.ftg.ftype, FType_Generic_OLE) or issubclass(oid.ftg.ftype, FType_Generic_OpenXML):
