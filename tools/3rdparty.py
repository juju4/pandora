...
if __name__ == "__main__":
    ...
    moments = requests.get(
        f"https://cdnjs.cloudflare.com/ajax/libs/moment.js/{moments_version}/moment-with-locales.min.js"
    )
    ...
    chart = requests.get(
        f"https://cdnjs.cloudflare.com/ajax/libs/Chart.js/{chart_version}/chart.min.js"
    )
    with (dest_dir_js / "chart.min.js").open("wb") as f:
        f.write(chart.content)
        print(f"Downloaded chart v{chart_version}.")

    datepicker_js = requests.get(
        f"https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/{datepicker_version}/js/bootstrap-datepicker.min.js"
    )
    ...
    datepicker_css = requests.get(
        f"https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/{datepicker_version}/css/bootstrap-datepicker.min.css"
    )
    ...
    dropzone_js = requests.get(
        f"https://unpkg.com/dropzone@{dropzone_version}/dist/dropzone-min.js"
    )
    ...
    dropzone_css = requests.get(
        f"https://unpkg.com/dropzone@{dropzone_version}/dist/dropzone.css"
    )
    ...
    datatables_css = requests.get(
        f"https://cdn.datatables.net/{datatables_version}/css/jquery.dataTables.min.css"
    )
    ...
    datatables_js = requests.get(
        f"https://cdn.datatables.net/{datatables_version}/js/jquery.dataTables.min.js"
    )
